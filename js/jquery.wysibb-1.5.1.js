...
( function ( $ ) {
	...
	$.wysibb = function ( txtArea, settings ) {
		...
		this.options = {
			...
			// blockquote: [[" {SELTEXT}",{seltext:
			// {rgx:false,attr:false,sel:false}}]]
			},
			smileList : [
			// {title:CURLANG.sm1, img: '<img
			// src="{themePrefix}{themeName}/img/smiles/sm1.png" class="sm">',
			// bbcode:":)"},
			],
			attrWrap : [
					'src', 'color', 'href'
			]
		// use becouse FF and IE change values for this attr, modify [attr] to
		// _[attr]
		};
